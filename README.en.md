...
This repository is a central index for Codex skills maintained by Guangyao Yin. It follows the general idea of `lovstudio/skills`: individual skills usually live in separate repositories, and some may live under this repository's `skills/` directory. This repository provides a unified catalog, installation commands, and a machine-readable manifest.
